...
(() => {
  ...
  var require_use_sync_external_store_shim_development = __commonJS({
    "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
      ...
      (function() {
        ...
        "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
        var React41 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState17 = React41.useState, useEffect17 = React41.useEffect, useLayoutEffect5 = React41.useLayoutEffect, useDebugValue = React41.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
  ...
  var File = createLucideIcon("file", __iconNode7);
  ...
  var Forward = createLucideIcon("forward", __iconNode8);
  ...
  var Reply = createLucideIcon("reply", __iconNode9);
  ...
  var useChatStore = create((set, get) => ({
    ...
    handleNewMessage: (message2) => {
      set((state) => {
        const conversationId = message2.conversationId;
        const currentMessages = state.messages[conversationId] || [];
        const updatedMessages = [...currentMessages, message2];
        const updatedConversations = state.conversations.map(
          (conv) => conv.id === conversationId ? {
            ...
            lastMessage: {
              ...
              sentAt: message2.createdAt,
              type: message2.type
            },
            updatedAt: message2.createdAt
          } : conv
        );
  ...
  function MessageBubble({ message: message2, showAvatar, isGrouped }) {
    ...
    const conv = conversations?.find((c) => (c.id || c._id) === message2.conversationId);
    const participantInfo = conv?.participants?.find((p) => {
      const uid = p?.user?._id || p?.user?.id || p?.user;
      return uid && String(uid) === String(message2.senderId);
    });
    const sender = message2.sender && typeof message2.sender === "object" ? message2.sender : participantInfo?.user || { name: message2.senderId };
    const isOutgoing = currentUser && String(currentUser._id || currentUser.id) === String(message2.senderId);
    const isRead = message2.status?.readBy?.length > 0;
    ...
    const handleDelete = () => {
      deleteMessage(message2.id, false);
    };
    const handleAddReaction = (emoji) => {
      addReaction(message2.id, emoji);
    };
    const renderMessageContent = () => {
      switch (message2.type) {
        case "text":
          return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "whitespace-pre-wrap break-words", children: message2.content });
        case "image":
          return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "space-y-2", children: message2.attachments?.map((attachment, index2) => /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: "relative", children: [
            ...
            message2.content && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("p", { className: "text-sm mt-1", children: message2.content })
          ] }, index2)) });
        case "file":
          return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: "space-y-2", children: [
            message2.attachments?.map((attachment, index2) => /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: "flex items-center gap-3 p-3 bg-slate-100 rounded-lg", children: [
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(File, { className: "w-8 h-8 text-slate-500 flex-shrink-0" }),
              /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("p", { className: "text-sm font-medium truncate", children: attachment.name }),
                /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("p", { className: "text-xs text-slate-500", children: formatFileSize(attachment.size) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
                Button,
                {
                  ...
                  variant: "ghost",
                  onClick: () => window.open(attachment.url, "_blank"),
                  children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Download, { className: "w-4 h-4" })
                }
              )
            ] }, index2)),
            message2.content && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("p", { className: "text-sm", children: message2.content })
          ] });
        case "audio":
          return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: "space-y-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: "flex items-center gap-3 p-3 bg-slate-100 rounded-lg", children: [
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "w-3 h-3 bg-white rounded-full" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: "flex-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("p", { className: "text-sm font-medium", children: "Audio message" }),
                /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("p", { className: "text-xs text-slate-500", children: "0:30" })
              ] })
            ] }),
            message2.content && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("p", { className: "text-sm", children: message2.content })
          ] });
    ...
    const renderStatusIcon = () => {
      ...
      if (!message2.status?.sent) {
        return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Clock, { className: "w-3 h-3 text-slate-400" });
      } else if (!isRead) {
        return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Check, { className: "w-3 h-3 text-slate-400" });
      } else {
        return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(CheckCheck, { className: "w-3 h-3 text-blue-500" });
      }
    };
    return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: `flex gap-3 group ${isOutgoing ? "justify-end" : "justify-start"}`, children: [
      !isOutgoing && showAvatar && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Avatar2, { className: "w-8 h-8 flex-shrink-0", children: sender.avatar ? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(AvatarImage2, { src: sender.avatar, alt: sender.name }) : /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(AvatarFallback2, { className: "bg-gradient-to-br from-blue-500 to-purple-600 text-white text-xs", children: sender.name.charAt(0) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: `flex flex-col max-w-[70%] ${isOutgoing ? "items-end" : "items-start"}`, children: [
        !isOutgoing && !isGrouped && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { className: "text-xs text-slate-500 mb-1 px-3", children: sender.name }),
        /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
          "div",
          {
            className: `relative px-4 py-2 rounded-2xl shadow-sm ${isOutgoing ? "bg-blue-500 text-white" : "bg-white text-slate-900 border border-slate-200"}`,
            onMouseEnter: () => setShowMenu(true),
            onMouseLeave: () => setShowMenu(false),
            children: [
              renderMessageContent(),
              message2.reactions?.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: "flex flex-wrap gap-1 mt-2", children: message2.reactions?.map((reaction, index2) => /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
                "span",
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { className: `absolute top-0 ${isOutgoing ? "-left-8" : "-right-8"} opacity-0 group-hover:opacity-100 transition-opacity`, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(DropdownMenu2, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(DropdownMenuTrigger2, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
                  Button,
                  {
                    variant: "ghost",
                    size: "sm",
                    className: "h-6 w-6 p-0 hover:bg-slate-100",
                    children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(EllipsisVertical, { className: "w-3 h-3" })
                  }
                ) }),
                /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(DropdownMenuContent2, { align: isOutgoing ? "end" : "start", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(DropdownMenuItem2, { onClick: handleReply, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Reply, { className: "w-4 h-4 mr-2" }),
                    "Reply"
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(DropdownMenuItem2, { onClick: () => handleAddReaction("\u{1F44D}"), children: "\u{1F44D} Like" }),
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(DropdownMenuItem2, { onClick: () => handleAddReaction("\u2764\uFE0F"), children: "\u2764\uFE0F Love" }),
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(DropdownMenuItem2, { onClick: () => handleAddReaction("\u{1F602}"), children: "\u{1F602} Laugh" }),
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(DropdownMenuSeparator2, {}),
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(DropdownMenuItem2, { onClick: () => navigator.clipboard.writeText(message2.content), children: [
                    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Copy, { className: "w-4 h-4 mr-2" }),
                    "Copy"
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(DropdownMenuItem2, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Forward, { className: "w-4 h-4 mr-2" }),
                    "Forward"
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(DropdownMenuItem2, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Star, { className: "w-4 h-4 mr-2" }),
                    "Star"
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(DropdownMenuSeparator2, {}),
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { className: `flex items-center gap-1 mt-1 text-xs text-slate-500 ${isOutgoing ? "justify-end" : "justify-start"}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { children: message2.createdAt ? formatTime(message2.createdAt) : "" }),
          renderStatusIcon()
        ] })
      ] })
    ] });
